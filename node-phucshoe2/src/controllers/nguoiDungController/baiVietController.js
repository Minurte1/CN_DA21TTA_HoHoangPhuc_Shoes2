...
const createBaiViet = async (req, res) => {
  ...
  try {
    const [results] = await connection.execute(
      "INSERT INTO `ID_BAI_VIET` (ID_NGUOI_DUNG, TIEU_DE, NGAY_TAO_BLOG, NGAY_CAP_NHAT_BAIVIET, NOI_DUNG_BAIVIET, TRANG_THAI_BAIVIET) VALUES (?, ?, NOW(), NOW(), ?, ?)",
      [ID_NGUOI_DUNG, TIEU_DE, NOI_DUNG_BAIVIET, TRANG_THAI_BAIVIET]
    );
    res
      .status(201)
