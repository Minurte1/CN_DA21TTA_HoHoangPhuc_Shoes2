  ...
  useEffect(() => {
    const fetchRecommendedProducts = async () => {
      try {
        ...
        setProducts(response.data.recommendations || []); // Set danh sách sản phẩm gợi ý
        setProductLength(response.data.recommendations.length || 0);
      } catch (error) {
...
export default RecommenderProductCarousel;
